    ...
    init {
        ...
        if (a != null) {
            val allEdgesCornerRadius =
                a.getDimensionPixelSize(R.styleable.WindowBlurLinearLayout_cornerRadius, 0)

            val cornerRadius = CornersRadius(
                formatEdgeCornerRadius(
                    allEdgesCornerRadius,
                    a.getDimensionPixelSize(
                        R.styleable.WindowBlurLinearLayout_cornerRadiusTopLeft,
                        -1
                    )
                ),
                formatEdgeCornerRadius(
                    allEdgesCornerRadius,
                    a.getDimensionPixelSize(
                        R.styleable.WindowBlurLinearLayout_cornerRadiusTopRight,
                        -1
                    )
                ),
                formatEdgeCornerRadius(
                    allEdgesCornerRadius,
                    a.getDimensionPixelSize(
                        R.styleable.WindowBlurLinearLayout_cornerRadiusBottomLeft,
                        -1
                    )
                ),
                formatEdgeCornerRadius(
                    allEdgesCornerRadius,
                    a.getDimensionPixelSize(
                        R.styleable.WindowBlurLinearLayout_cornerRadiusBottomRight,
                        -1
                    )
                )
            )
            ...
            blurController = SystemBlurController(
                ...
                a.getInteger(
                    R.styleable.WindowBlurLinearLayout_blurRadius,
