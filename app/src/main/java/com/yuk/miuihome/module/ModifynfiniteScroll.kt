    ...
    fun init() {
        if (OwnSP.ownSP.getBoolean("infiniteScroll", false)) {
            "com.miui.home.launcher.ScreenView".hookAfterMethod(
                ...
                val screenCount =
                    XposedHelpers.callMethod(it.thisObject, "getScreenCount") as Int
                if (it.args[2] as Int == -1 && it.args[0] as Int == 0) it.result =
                    screenCount else if (it.args[2] as Int == 1 && it.args[0] as Int == screenCount - 1)
                    it.result = 0
            }
            ...
            "com.miui.home.launcher.ScreenView".hookAfterMethod(
                ...
                if (it.result as Int == 0) it.result =
                    screenCount else if (it.result as Int == screenCount - 1)
                    it.result = 0
            }
        }
    }
