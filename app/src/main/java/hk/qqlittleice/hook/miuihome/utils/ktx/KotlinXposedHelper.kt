...
package hk.qqlittleice.hook.miuihome.utils.ktx
...
fun String.hookMethod(method: String?, vararg args: Any?, classLoader: ClassLoader = HomeContext.classLoader) = try {
...
inline fun String.hookBeforeMethod(method: String?, vararg args: Any?, classLoader: ClassLoader = HomeContext.classLoader, crossinline hooker: (MethodHookParam) -> Unit) = try {
...
inline fun String.hookAfterMethod(method: String?, vararg args: Any?, classLoader: ClassLoader = HomeContext.classLoader, crossinline hooker: (MethodHookParam) -> Unit) = try {
...
fun String.setReturnConstant(method: String?, vararg args: Any?, result: Any?, classLoader: ClassLoader = HomeContext.classLoader) = try {
...
inline fun String.replaceMethod(method: String?, vararg args: Any?, classLoader: ClassLoader = HomeContext.classLoader, crossinline hooker: (MethodHookParam) -> Any?) = try {
...
inline fun String.replaceAfterAllMethods(methodName: String?, classLoader: ClassLoader = HomeContext.classLoader, crossinline hooker: (MethodHookParam) -> Any?) = try {
...
inline fun String.hookBeforeConstructor(vararg args: Any?, classLoader: ClassLoader = HomeContext.classLoader, crossinline hooker: (MethodHookParam) -> Unit) = findClass(classLoader).hookConstructor(*args, object : XC_MethodHook() {
    override fun beforeHookedMethod(param: MethodHookParam) {
        try {
            hooker(param)
        } catch (e: Throwable) {
...
inline fun String.hookAfterConstructor(vararg args: Any?, classLoader: ClassLoader = HomeContext.classLoader, crossinline hooker: (MethodHookParam) -> Unit) = findClass(classLoader).hookConstructor(*args, object : XC_MethodHook() {
    override fun afterHookedMethod(param: MethodHookParam) {
        try {
            hooker(param)
        } catch (e: Throwable) {
...
inline fun String.replaceConstructor(vararg args: Any?, classLoader: ClassLoader = HomeContext.classLoader, crossinline hooker: (MethodHookParam) -> Unit) = findClass(classLoader).hookConstructor(*args, object : XC_MethodReplacement() {
    override fun replaceHookedMethod(param: MethodHookParam) {
        try {
            hooker(param)
        } catch (e: Throwable) {
...
fun String.callStaticMethod(methodName: String?, vararg args: Any?, classLoader: ClassLoader = HomeContext.classLoader) = findClass(classLoader).callStaticMethod(methodName, *args)

@Suppress("UNCHECKED_CAST")
fun <T> String.callStaticMethodAs(methodName: String?, vararg args: Any?, classLoader: ClassLoader = HomeContext.classLoader) = findClass(classLoader).callStaticMethod(methodName, *args) as T
...
fun String.findClassOrNull(classLoader: ClassLoader? = HomeContext.classLoader): Class<*>? = findClassIfExists(this, classLoader)
