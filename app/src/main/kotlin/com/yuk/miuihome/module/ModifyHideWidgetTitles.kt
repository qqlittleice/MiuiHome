...
class ModifyHideWidgetTitles {
    ...
    fun init() {
        ...
        "com.miui.home.launcher.LauncherAppWidgetHost".hookAfterMethod("createLauncherWidgetView", Context::class.java, Int::class.javaPrimitiveType, widgetInfo, widgetProviderInfo
        ) {
